...
export function DailyProgressWidget() {
  ...
  return (
    <div className="w-full max-w-[304px] flex flex-col gap-0 p-[4px] bg-[#010101] rounded-[8px] mx-auto font-dm-sans">
      {/* Top Container */}
      <button 
      ...
      {/* Bottom Container */}
      {isOpen && (
        <div className="w-full bg-transparent px-2 pt-2 pb-3 flex flex-col gap-3">
          {/* list-task container */}
